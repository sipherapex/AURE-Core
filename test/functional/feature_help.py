...
"""Verify that starting aure with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aure with -h for help text")
        ...
        self.log.info("Start aure with -version for version information")
        ...
        self.log.info("Start aured with -fakearg to make sure it does not start")
