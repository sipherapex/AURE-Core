...
{
    const char* pszTimestamp = "Aure Network Launch - 29 Jan 2026 - The Future of Privacy and Freedom";
    const CScript genesisOutputScript = CScript() << ParseHex("040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4d915752600569306b0296be") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x62e0131a7ffac9fc35878f7fa286e5fdb2d158ff8e1efa67336c37516f9346c2");
        ...
        genesis = CreateGenesisBlock(1738137600, 1, 0x207fffff, 1, 21000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x62e0131a7ffac9fc35878f7fa286e5fdb2d158ff8e1efa67336c37516f9346c2"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e1e41d897881adfdfa27d9892f1802888b4523e388e979ff29d030a92c85075"));
       ...
       // vSeeds.emplace_back("seed-a.aure.loshan.co.uk");
       // vSeeds.emplace_back("dnsseed.thrasher.io");
       // vSeeds.emplace_back("dnsseed.auretools.com");
       // vSeeds.emplace_back("dnsseed.aurepool.org");
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeoutHeight = 0; // 364 days later
       ...
       // vSeeds.emplace_back("testnet-seed.auretools.com");
       // vSeeds.emplace_back("seed-b.aure.loshan.co.uk");
