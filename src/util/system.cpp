...
const char * const BITCOIN_CONF_FILENAME = "aure.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Aure";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Aure";
#else
    // Unix-like
    return pathRet / ".aure";
#endif
