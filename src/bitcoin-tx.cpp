...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aure-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aure-tx [options] <hex-tx> [commands]  Update hex-encoded aure transaction\n" +
            "or:     aure-tx [options] -create [commands]   Create hex-encoded aure transaction\n" +
            "\n";
