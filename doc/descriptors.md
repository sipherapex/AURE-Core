# Support for Output Descriptors in Aure Core

Since Aure Core v0.17, there is support for Output Descriptors. This is a
...
existing Aure Core wallets, a convenience function `combo` is
