Contributing to Aure Core
============================

The Aure Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Aure Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/aure-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to aure-qt
...
The following applies to code changes to the Aure Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Aure
Network Protocol consensus changes.

Whether a pull request is merged into Aure Core rests with the project merge
...
Patches that change Aure consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aure consensus, it must have been
...
The project leader is the release manager for each Aure Core release.
